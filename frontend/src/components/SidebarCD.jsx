...
import publicationIcon from '../assets/icons/publication.png';
...
function SidebarCD() {
  ...
  // Define paths for your items - Chef Département
  const items = [
  ...
  const publicationItems = [
    { key: 'Publications', path: '/dashboard/publications', icon: publicationIcon, hasRoute: true }
  ];
