    ...
    <>
      ...
      <div className={`tr-table w-full flex items-center justify-between border-b border-[#E0E0E0] h-[55px] bg-white hover:bg-gray-50 transition-colors ${isExpanded ? 'border-b-0' : ''}`}>
        ...
        <div className="td-table w-[20%] flex items-center justify-end gap-2 pr-6">
          <button onClick={() => onEdit(room)} className="w-[30px] h-[30px] rounded-[6px] bg-[#a6eec3] flex justify-center items-center hover:-translate-y-1 transition-all duration-300">
            <img src="/src/assets/icons/editer1.png" alt="Edit" className="w-[14px] h-[14px]" />
          </button>
          
          <button onClick={() => onDelete(room)} className="w-[30px] h-[30px] rounded-[6px] bg-[#fca5a5] flex justify-center items-center hover:-translate-y-1 transition-all duration-300">
