...
import rmIcon from '../assets/icons/RM.png';
...
function SidebarETD() {
  ...
  // Define paths for your items - Etudiant
  const mainItems = [
  ...
  const examItems = [
    { key: 'Mes Examens', path: '/dashboard/mes-examens', icon: exIcon, hasRoute: true },
    { key: 'Mes Controles Continues', path: '/dashboard/mes-cc', icon: ccIcon, hasRoute: true },
    { key: 'Mes Remplacements', path: '/dashboard/mes-remplacements', icon: rmIcon, hasRoute: true },
    { key: 'Mes Rattrapages', path: '/dashboard/mes-rattrapages', icon: rpIcon, hasRoute: true }
  ];
